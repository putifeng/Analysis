...
namespace Analyzers
{
    ...
    public class SampleSemanticAnalyzer : DiagnosticAnalyzer
    {
        ...
        private static readonly LocalizableString Title = "AB0002Title";

        // The message that will be displayed to the user.
        private static readonly LocalizableString MessageFormat = "AB0002MessageFormat";

        private static readonly LocalizableString Description = "AB0002Description";
